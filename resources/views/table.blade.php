...
<head>
    ...
    <!-- favicon -->
    <link rel=icon href="{{ asset('html/assets/img/favicon.png') }}" sizes="16x16" type="icon/png">
    <!-- animate -->
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="productWrap d-flex align-items-center">
                                                        <img src="html/assets/img/gallery/product1.jpg" alt="image">
                                                    </td>
                                                    <td>Nicole Brooks</td>
                                                    <td>5425683 </td>
                                                ...
                                                <tr>
                                                    <td class="productWrap d-flex align-items-center">
                                                        <img src="html/assets/img/gallery/product2.jpg" alt="image">
                                                    </td>
                                                    <td>Nicole Brooks</td>
                                                    <td>5425683 </td>
                                                    <td>$Darlene Robertson</td>
                                                ...
                                                <tr>
                                                    <td class="productWrap d-flex align-items-center">
                                                        <img src="html/assets/img/gallery/product3.jpg" alt="image">
                                                    </td>
                                                    <td>Nicole Brooks</td>
                                                    <td>5425683 </td>
                                                    <td>$Darlene Robertson</td>
                                                ...
                                                <tr>
                                                    <td class="productWrap d-flex align-items-center">
                                                        <img src="html/assets/img/gallery/product4.jpg" alt="image">
                                                    </td>
                                                    <td>Nicole Brooks</td>
                                                    <td>5425683 </td>
                                                    <td>$Darlene Robertson</td>
